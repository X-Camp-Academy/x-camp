declare const json: {
  ...
  'BecomeOurPartner.Desc': 'X-Camp致力于建立具有广泛影响力的编程社区。我们的主要目标是培养一个支持青少年从事编程学习的社区环境。';
  'C++.Grade': '6年级及以上';
  'C++.Title': 'C++知识';
  Calendar: '日历';
  ...
  'USACOSpotlight.Desc': '过去5年，X-Camp学生在美国信息学奥林匹克竞赛中取得了令人瞩目的成绩：超过200名X-Camp学生达到USACO白银级别及以上，其中包括30人达到白金级别，12人入选美国国家集训队，其中7人在2023年最新赛季入选，1人入选美国女子国家队。';
  ...
  UpcomingEvents: '活动预告';
  'UpcomingEvents.Desc': '我们将不定期计划一系列聚会和活动，以便与广大校友社区联系。请关注活动更新，并记下时间参加！';
  ...
  'USACOPublicMockTest.Desc': 'USACO Public Mock Test';
  'USACOMockTestClass.Title': 'USACO Public Mock Test';
  'USACOMockTestClass.Desc': 'USACO Public Mock Test';
  'USACOSharingSession.Title': 'USACO Public Mock Test';
  'USACOSharingSession.Desc': 'USACO Public Mock Test';
