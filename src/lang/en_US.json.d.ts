declare const json: {
  ...
  "Website": "Website",
  "WeeklyOpenHouse": "X-Camp Online Open House",
  "WeeklyOpenHouse.color": "X-Camp Online Open House",
  "WeeklyOpenHouse1": "Weekly Open House",
  "weeklyOpenHouseOpen": "Tue night 6:30-7:30 on Zoom",
  ...
  "USACO.Desc1": "Trom 2022 USACO Season,X-Camp teaching research team provide USACO authentic mock test to ALL beforeDec real USACO contest comes. lt's a benifit for current students chasing new USACO achievements inupcoming seasons. it also benefits the competitive programming community due to the shortage of highquality test problems.",
  "USACO.Desc2": "The USACO Enhancement Class is offered from October to March targeting all four levels and us Camp. Thewill be a weekly mock test which students gather to finish in actual competition time settings. After mock teends, our instructor will deliver live solution.",
  "USACO.Activity3": "USACO Sharing Session",
  "USACO.Desc3": "X-Camp teaching team will invite distinguished speakers like USACO Director Dr. Brian Dean, our previousalumnis, and our current students deliver different topics about USACO. If you are interested in USACO, followour social media platform or subscribe to our newsletter. Keep you posted.",
