declare const json: {
  ...
  'Courses.Camps.Banner.Desc1': 'X-Camp holds two training camps every year ';
  ...
  'Home.Banner1.mbDesc1': 'Free USACO Mock Test';
  'Home.Banner1.mbDesc2': 'From Bronze to Platinum';
  'Home.Banner1.Desc3': "Exploring the specifics of X-Camp's diverse classes";
  'Home.Banner1.Date1': '* Pacific Time, 12/09/2023, Sat, 4 PM - 8 PM';
  'Home.Banner1.Date2': '* Beijing Time, 12/10/2023, Sun, 7 AM - 11 AM';
  ...
  'Courses.Camps.Banner.Desc2': 'Summer On-Site Camps';
  Tel: 'Tel: ';
  Text: 'Text: ';
  Timeline: 'Timeline';
  ...
  'Courses.Camps.Banner.Desc3': 'Winter On-Site Camps';
  ...
  'Contact.Phone.info1': 'Text us at 408-634-0281';
  'Contact.Phone.info2': 'Call us at 510-708-8390';
  ...
  'Assessment.Banner.Description': 'X-Camp offers a variety of methods to assist children in finding classes that best suit their needs. This includes a self-assessment tool, a coding-based placement test, and personalized one-on-one consultations.';
  'Assessment.form.title': 'Quick assessment to match your kid to the right class';
  'Assessment.form.stuName': "Student's Name";
  'Assessment.form.Email': 'Email';
  'Assessment.form.Phone': 'Phone Number';
  'Assessment.form.Grade': 'Grade';
  'Assessment.form.CodingBackground': 'Coding Background';
  'Assessment.form.CodingLanguage': 'Coding Language';
  'Assessment.form.ContestExperience': 'Programming Contest Experiences(ex. USACO Silver)';
  'Assessment.form.AboutXCamp': 'How did you hear about X-Camp?';
  'Assessment.form.stuName.required': 'Please input your name';
  'Assessment.form.Email.required': 'Please input your email';
  'Assessment.form.Phone.required': 'Please input your phone number';
  'Assessment.form.Grade.required': 'Please select your grade';
  'Assessment.form.CodingBackground.required': 'Please select your coding background';
  'Assessment.form.CodingLanguage.required': 'Please select your coding language';
  'Assessment.form.AboutXCamp.required': 'Please select how did you hear about X-Camp';
  'Assessment.form.Email.format': 'Please input a valid email';
  'Assessment.form.CodingBackground.NoCodingExperience': 'No coding experience';
  'Assessment.form.CodingBackground.LessThanHalfYear': '< half year coding experience';
  'Assessment.form.CodingBackground.LessThanOneYear': '< 1 year coding experiences';
  'Assessment.form.CodingBackground.MoreThanOneYear': '> 1 year coding experiences';
  'Assessment.form.CodingBackground.MoreThanTwoYear': '> 2 year coding experiences';
  'Assessment.form.CodingLanguage.NoCodingExperience': 'No coding experience';
  'Assessment.form.CodingLanguage.Python': 'Python coding experiences';
  'Assessment.form.CodingLanguage.Java': 'Java coding experiences';
  'Assessment.form.CodingLanguage.C++': 'C++ coding experiences';
  'Assessment.form.AboutXCamp.Consultant': 'X-Camp Consultant';
  'Assessment.form.AboutXCamp.OfficialAccount': 'X-Camp WeChat Official Account';
  'Assessment.form.AboutXCamp.Events': 'X-Camp Events';
  'Assessment.form.AboutXCamp.SocialMedia': 'X-Camp Social Media(FB, Linkedin, Twitter)';
  'Assessment.form.AboutXCamp.Contest': 'Contest(HPI, Turing Cup)';
  'Assessment.form.AboutXCamp.USACO': 'usaco.org';
  'Assessment.form.AboutXCamp.Discord': 'Discord (Teamscode, CinT, LiT)';
  'Assessment.form.AboutXCamp.GoogleSearch': 'Google Search';
  'Assessment.form.AboutXCamp.WeChatMoments': 'Wechat Moments';
  'Assessment.form.AboutXCamp.Friend': 'Word of mouth/Friends';
  'Assessment.form.AboutXCamp.Other': 'Other';
  'Assessment.form.AboutXCamp.Xiaohongshu': 'Xiaohongshu';
  'Assessment.form.success': 'Thanks for your interest, our teaching counselor will contact you within 48 hours.';
  'Assessment.form.fail': 'Failed to submit';
  ...
  Loading: 'Loading';
  'Home.Banner2.Desc1': 'ChatGPT industry comes, whether our next generation need to learn coding?';
  'Home.Banner2.Desc2': "With AI popular coding language Python's help, enter the AI-powered world !";
  'Home.Banner2.Date1': '* Pacific Time, Nov 26, 2023, 5:00 PM - 7:00 PM';
  'Home.Banner2.Date2': '* Beijing Time, Nov 27, 2023, 9:00 AM - 11:00 AM';
  ...
  'Home.Banner2.Title1.Color': 'Python Trial Class, Only';
};
