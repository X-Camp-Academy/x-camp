declare const json: {
  ...
  'Evaluation.topBanner.description': 'X-Camp offers a variety of methods to assist children in finding classes that best suit their needs. This includes a self-assessment tool, a coding-based placement test, and personalized one-on-one consultations.';
