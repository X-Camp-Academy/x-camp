declare const json: {
    ...
    "Duration": "Duration",
    "Earn": "Earn",
    "EducationForum": "Education Forums",
    "Email": "Email",
    ...
    "Faculty": "Faculty",
    "Faculty.Des": "X-Camp teachers are composed of senior engineers from leading tech companies and accomplished contestants from international and national level informatic contests such as IOI, ICPC, and USACO.",
    "Faculty.Desc": "Our world-class faculty is composed of experienced senior engineers from leading tech companies, accomplished computer science majors from prestigious universities, and top-ranking participants of competitive programming contests including IOI, ICPC, and USACO.",
    ...
    "Public": "Public",
    "Python.Grade": "Grades 5+",
    "Python.Title": "Python for Beginners",
    "Q&A": "Q&A",
    ...
    "SchoolCalendar.Description": "X-Camp offers beginner to IOI level programming classes with structured, self-paced curriculum",
    "Search": "Search",
    ...
    "StudentProjects.Desc1": "Every quarter, X-camp hosts its own Art of Python Programming contest alongside other projects and events to inspire students. These events are great opportunities for students to showcase what they have learned from class!",
    ...
    "USACO.Desc": "Over the last 5 years, X-Camp students have achieved top performances at USACO:",
    "USACO.DownloadPackage": "Download our free USACO Intro Package",
    "USACO.Grade": "Grades 7+",
    "USACO.Title": "USACO Grandmaster",
    "USACOClasses": "USACO classes",
    "USACOFinalist": "USACO Finalists",
    "USACOLiveSolution": "USACO Live Solutions",
    "USACOMedal": "USACO Medals",
    "USACOMedal.Desc": "X-Camp students have accomplished impressive results in the USA Coding Olympiad over the last 5 years: More than 200 X-Camp students have been qualified for USACO Silver division and above, including 30 in the Platinum division and 12 selected for the US Training Camp, 7 of which are fresh from the 2023 season.",
    ...
    "WeSupport.Desc": "X-Camp's programming courses are tailored for students grades 5 through 12, and offer support for three mainstream programming languages: Python, Java, and C++. Our Intro to Python course serves as a good general introduction to coding, and our Intro to Java course prepares students for APCSA. Our C++ courses are offered at the Beginner, Intermediate, and Advanced levels.",
    "WhyWorkWithUs": "Why Work With Us",
    "WhyWorkWithUs.Desc": "X-Camp strives to cultivate an inclusive and dynamic environment by attracting top students from diverse backgrounds. We highly value and respect the contributions of all individuals. As part of our commitment to excellence, if a candidate is recommended by parents of X-Camp students and subsequently offered a position, the referring student will receive a one-time $500 tuition waiver.",
    ...
    "X_Alumni.Desc": "Since its inception, X-Camp has successfully enrolled over 1,000 students and currently serves more than 500 students from over 250 schools worldwide. If you would like to reconnect with your fellow classmates, please contact us!",
    "X-Camp.Desc1": "X-Camp Academy is an institute based in the Silicon Valley that offers coding classes for middle and high school students, focused on building mastery of data structures and algorithms. Our goal is to equip students with the necessary skills to excel in contests like USACO and beyond. Explore our recent updates and offerings here.",
    ...
    "WhyContest": "Why Contests?",
    "WhyContest.Desc": "Students are drawn to participating in competitive programming contests for several reasons:",
    ...
    "MoreUSACOSolution": "Find more X-Camp USACO Solutions on our Youtube Playlist",
    ...
    "WeeklyEducationForum": "Weekly Education Forum",
    "WeeklyEducationForum.Desc": "At X-Camp, we actively invite experienced speakers to share their knowledge and insights within our community. These esteemed speakers contribute valuable perspectives, inspiring and guiding both students and parents alike in their programming education journey. We are committed to fostering a vibrant and inclusive community where knowledge is shared and celebrated.",
