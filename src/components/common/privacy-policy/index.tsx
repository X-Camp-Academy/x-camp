...
const PrivacyPolicy = () => {
  ...
  const whoMayHaveAccessToYourInformation = {
    en: {
      ...
      list: [
        {
          description: "If you have been referred for a job at X-Camp Academy by a current employee of ours, with your consent, we may inform that employee about the progress of your application and let the employee know the outcome of the process. In some cases, if it is identified that you have attended the same university/school or shared the same previous employer during the same period as a current X-Camp employee we may consult with that employee for feedback on you."
          , children: []
        },
        {
          description: "X-Camp Academy may also use service providers acting on X-Camp’s behalf to perform some of the services described above including for the purposes of the verification / background checks. These service providers may be located outside the country in which you live or the country where the position you have applied for is located."
          , children: []
        },
        {
          description: "  X-Camp Academy may sometimes be required to disclose your information to external third parties such as to local labor authorities, courts and tribunals, regulatory bodies and/or law enforcement agencies for the purpose of complying with applicable laws and regulations, or in response to legal process."
          , children: []
        },
        {
          description: "We will also share your personal information with other third parties if we have your consent (for example if you have given us permission to contact your referees), or to detect, prevent or otherwise address fraud, security or technical issues, or to protect against harm to the rights, property or safety of X-Camp Academy, our users, applicants, candidates, employees or the public or as otherwise required by law."
          , children: []
        },
        {
    ...
    zh: {
      ...
      list: [
        {
          description: "如果我们的现任员工向您推荐 X-Camp Academy 的工作，经您同意，我们可能会通知该员工您的申请进展情况，并让该员工知道该流程的结果。在某些情况下，如果发现您与 X-Camp 现任员工在同一时期就读于同一所大学/学校或同一前任雇主，我们可能会咨询该员工以获取有关您的反馈。"
          , children: []
        },
        {
        ...
        {
          description: "如果我们征得您的同意（例如，如果您允许我们联系您的推荐人），或者为了检测、防止或以其他方式解决欺诈、安全或技术问题，或者为了防止欺诈，我们还将与其他第三方共享您的个人信息。损害 X-Camp Academy、我们的用户、申请人、候选人、员工或公众的权利、财产或安全或法律另有要求的。"
          , children: []
        },
        {
        ...
        {
          description: "X-Camp在多个国家和地区运营，这意味着您的信息可能会在最初收集信息的国家或地区（包括美国）之外存储和处理。在其中一些国家/地区，您对自己的信息享有的权利可能少于您在居住国/地区的权利。无论您的信息在何处处理，我们都会应用本政策中描述的相同保护措施。我们还遵守与数据传输相关的某些法律框架，例如下文所述的欧洲框架。欧盟委员会已确定欧洲经济区 (EEA) 以外的某些国家/地区充分保护个人数据。您可以在欧盟委员会网站上查看当前的欧盟委员会充分性决定。为了将数据从欧洲经济区传输到其他国家（例如美国），我们遵守建立与欧盟法律同等保护水平的法律框架。"
          , children: [
  ...
  const categoriesOfInformationWeCollect = [
    ...
    { head: 'Demographic information', content: ', such as your age, gender, and language(s) spoken. If you choose, you may also provide additional information, like your racial or ethnic origin, religious or philosophical beliefs, trade union membership, sexual orientation, or gender identity.' },
    { head: 'Financial information', content: ', such as your current and/or desired salary and other terms relating to compensation and benefits packages.' },
    { head: 'Geolocation data', content: ', including as determined by IP address, depending in part on your device and account settings.' },
    { head: 'Audio, electronic, visual, and similar information', content: ', such as information transmitted in connection with interviews or phone-screenings you may have, if any.' },
    { head: 'Communications data', content: ', such as emails that you may send or receive in connection with the application or recruitment process.' },
  ...
  const businessPurposes = [
    ...
    { head: 'Protecting against security threats, abuse, illegal activity, and violations', content: ': X-Camp Academy uses and may disclose information to detect, prevent and respond to security incidents, and for protecting against other malicious, deceptive, fraudulent, or illegal activity. ' },
    { head: 'Maintaining our services', content: ', : X-Camp Academy uses information to ensure our accounts systems and services are working as intended, such as tracking outages or troubleshooting bugs and other issues.' },
    { head: 'Research and development', content: ': X-Camp Academy uses information to improve our application and recruitment process, including improving diversity in recruitment practices.' },
    ...
    <div className={styles.privacyPolicyContainer}>
      <div className={`${styles.privacyPolicy} container`}>
        ...
        <Space direction="vertical" style={{ marginTop: 25, width: '100%' }}>
          ...
          <div className={styles.text}>
            <div className={styles.description}>
              {typesInformationWeCollect[lang].description}
            </div>
            <List
        ...
        <Space direction="vertical" style={{ marginTop: 25, width: '100%' }}>
          ...
          <div className={styles.text}>
            <div className={styles.description}>
              {howWeUseInformationWeCollect[lang].description}
            </div>
            <List
