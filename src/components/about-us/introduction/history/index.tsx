  ...
  return (
    <div className={styles.historyContainer}>
      <div className="container">
        ...
        <Row gutter={isMobile ? [0, 18] : [48, 18]} className={styles.timeImage} style={{ display: 'flex', justifyContent: 'space-between' }}>
        ...
        <Row gutter={isMobile ? [0, 18] : [48, 18]} className={styles.timeImage}>
